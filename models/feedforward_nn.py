...
class Model(AdaptiveObject):
    ...
    def _process_minibatch(self, x: np.ndarray,
    ...
    def fit(self,
            train_data: Union[Tuple[np.ndarray, np.ndarray], Dataset],
            val_data: Union[Tuple[np.ndarray, np.ndarray], Dataset] = None,
    ...
    def evaluate(self,
                 test_data: Union[Tuple[np.ndarray, np.ndarray], Dataset],
