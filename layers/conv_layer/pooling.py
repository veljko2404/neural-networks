...
class Pooling(Function):
    ...
    def get_height(input_height: int, kernel_height: int, padding: int, stride: int) -> int:
        # Given the input height, kernel height, padding, and stride, we can compute the height of the output.
    ...
    def get_width(input_width: int, kernel_width: int, padding: int, stride: int) -> int:
        # Given the input width, kernel width, padding, and stride, we can compute the width of the output.
